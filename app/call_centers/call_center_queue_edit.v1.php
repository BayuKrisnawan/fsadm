...
//get http post variables and set them to php variables
	if (is_array($_POST)) {
		//get the post variables a run a security chack on them
			...
			$queue_autocallback=$_POST["queue_autocallback"];
...
*/
		//build the xml dialplan
			...
			if (isset ($queue_extension)) {
					$dialplan_xml .= "		<!-- Fix Chipmunk In Callcenters -->\n";
					$dialplan_xml .= "		<action application=\"set\" data=\"record_sample_rate=8000\"  inline=\"true\" />\n";
			}
			...
			$dialplan_xml .= "		<!-- Application Callcenter -->\n";
...
//show the content
	...
	echo "<tr>\n";
	echo "<td class='vncellreq' valign='top' align='left' nowrap>\n";
	echo "	Support Auto Callback\n";
	echo "</td>\n";
	echo "<td class='vtable' align='left'>\n";
	echo "	<input class='formfld' type='checkbox' name='queue_autocallback'>\n";
	echo "<strong>SUPPORT AUTO CALLBACK</strong>\n";
	echo "</td>\n";
	echo "</tr>\n";
